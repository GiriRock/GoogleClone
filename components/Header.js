...
function Header() {
  ...
  const searchInputRef = useRef(router.query.q)
  const search = (e) =>{
    e.preventDefault()
  ...
  return (
    <header>
        ...
        <Avatar className="ml-auto" url='https://lh3.googleusercontent.com/a-/AFdZucogqpCWuc8VxNTSWPL1kg7chhyK9nLoOmbGUcdQ71A=s83-c-mo'/>
        </div>
        <HeaderOptions />
    </header>
  )
